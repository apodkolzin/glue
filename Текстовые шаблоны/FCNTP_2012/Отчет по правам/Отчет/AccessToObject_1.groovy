 ...
 */
	...
	//def program = helper.get(parent.UUID)
        //Данный скрипт подразумевает присутствие специальной функции в справочнике groovy-скриптов. Функция прикреплена к задаче http://ssh-gate.naumen.ru:10305/lab_labour/show/11764?
        def program = helper.run("findProgram", ["object":object])
