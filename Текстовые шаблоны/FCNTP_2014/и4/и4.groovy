...
def order = OrderHibernateHandler.listOrderByOrderDate(stage?.acceptanceCommission, HibernateUtil.currentSession()).get(0) 
report.vars.orderDate = order.orderDate
report.vars.orderNumber = order.orderNumber
