...
import ru.naumen.fcntp.bobject.order.OrderHibernateHandler
...
//def act = helper.get('corebofs000080000kk6loj6bcoqc4jg')
...
if (stage?.acceptanceCommission != null) {
    def orders = OrderHibernateHandler.listOrderByOrderDate(stage?.acceptanceCommission, HibernateUtil.currentSession())
    if ((orders != null) && orders.size() > 0) {
        report.vars.orderDate = orders[0].orderDate
        report.vars.orderNumber = orders[0].orderNumber
    }
}
