...
'title': 'FCNTP_2014/QReportLetter/title4', 
'body': 'FCNTP_2014/QReportLetter/body4'] 
...
'UUID': subject.UUID,
'Period': subject.reportPeriod.title
] 
...
recieverPerson.each {person ->
         sendMailToEmployee(BusinessActionBase.unproxy(person), contract)
    } 
}