...
/* 
*L-17699 Доработать скрипт рассылки уведомления членам заседания НКС http://...te.naumen.ru:10305/lab_labour/show/17699 
* 
...
* 
* @author aboronnikov 
* По просьбе Петрова.А.Н скрипт временно заблокирован 
* */ 
...
//conference = helper.get('cnfrncfs000080000k8fekk6ehh98jn4') 
templateId = 'txttmpfs000080000k8bqcrr9ujsoc48' 
...
{ 
return "Материалы для рассмотрения_N" + conference.identifier + "_" + DateUtils.date2Str(conference.conferenceDate) + ".pdf" 
} 
