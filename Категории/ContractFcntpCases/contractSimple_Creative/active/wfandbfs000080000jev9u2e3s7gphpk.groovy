...
'first-nameAp': contract.applicant!=null?contract.applicant.firstName:"", 
'second-name': employee.middleName, 
'second-nameAp': contract.applicant!=null?contract.applicant.middleName:"", 
'lot-number': lot.fullNumber, 
'lot-theme': lot.theme, 
'contract-number': contract.identifier, 
'applicantTitle': contract.applicant==null?"":contract.applicant.title, 
...
parameters['respectableAp'] = SendMailScript.getRespectablePhrase(contract.applicant); 
