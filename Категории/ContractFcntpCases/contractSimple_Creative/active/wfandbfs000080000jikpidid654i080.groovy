...
'item1': 'KADR_2012/ContractLetterRRK/ContractLetterRRK_body2', 
'item2': 'KADR_2012/ContractLetterRRK/ContractLetterRRK_body1'] 
def paCodes = [ 
'2.1': 'KADR_2012/ContractLetterRRK/ContractLetterRRK_body2']; 
...
{ 
String tmpl = paCodes[contract.getProgramActions().get(0).displayableIdentifier]; 
if (tmpl != null) 
{ 
bodyTemplate = tmpl; 
} 
...
String body = SendMailScript.loadTemplate(bodyTemplate, employee); 
