//СКРИПТ РАССЫЛАЕТ УВЕДОМЛЕНИЯ НА E-MAIL АДРЕСА УЧАСТНИКАМ ПРОЦЕССА СОГЛАСОВАНИЯ
...
'title': 'RemarkOwnerDocumentLetter/OD_Remark_title',
'body': 'RemarkOwnerDocumentLetter/OD_Remark_body'],[
...
'title': 'RemarkOwnerDocumentLetter/NoRemarkOD_title',
'body': 'RemarkOwnerDocumentLetter/NoRemarkOD_body']
