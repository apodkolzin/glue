...
q.setMaxResults(1) 
def value = q.uniqueResult() 
def docVersion = value == null ? 1 : value.intValue() + 1; 
return docVersion; 
} 
...
def docVersion = getDocVersion(parent, caseCode, s); 
if (docVersion < 3) 
{ 
def boCase = docCases.getItem(caseCode) 
...
createDoc("stageReportDocumentation_220", session);