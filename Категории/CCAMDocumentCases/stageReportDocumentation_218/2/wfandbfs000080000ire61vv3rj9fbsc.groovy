//УВЕДОМЛЕНИЕ МОНИТОРА И СОКА О ТОМ, ЧТО ПОЛУЧАТЕЛЬ ЗАВЕРШИЛ РАЗМЕЩЕНИЕ ПАКЕТА ЭЛЕКТРОННОЙ ВЕРСИИ ОТЧЁТНОЙ ДОКУМЕНТАЦИИ
...
'title': 'P218_2010/AgreementOD/title',
'body': 'P218_2010/AgreementOD/body']
