//СКРИПТ РАССЫЛАЕТ УВЕДОМЛЕНИЯ НА E-MAIL АДРЕСА РРК оповещение о создании новой версии отчетной документации.
...
'title': 'RemarkOwnerDocumentLetter/ODnew_title', 
'body': 'RemarkOwnerDocumentLetter/ODnew_body'] 
